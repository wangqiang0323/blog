webpackJsonp([1,5],Array(885).concat([
/* 885 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__my_onsen_component__ = __webpack_require__(1186);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__page_type__ = __webpack_require__(1194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__page_home__ = __webpack_require__(1190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__page_blog__ = __webpack_require__(1188);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__page_login__ = __webpack_require__(1191);
...
var routes = [
    {
        path: '', component: __WEBPACK_IMPORTED_MODULE_4__my_onsen_component__["a" /* MyOnsenComponent */], children: [
            { path: '', redirectTo: 'login' },
            { path: 'login', component: __WEBPACK_IMPORTED_MODULE_8__page_login__["a" /* LoginComponent */], }
        ]
    },
    {
        path: 'type', component: __WEBPACK_IMPORTED_MODULE_5__page_type__["a" /* TypeComponent */]
    },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_8__page_login__["a" /* LoginComponent */], },
    { path: 'home', component: __WEBPACK_IMPORTED_MODULE_6__page_home__["a" /* HomeComponent */], },
    { path: 'blog', component: __WEBPACK_IMPORTED_MODULE_7__page_blog__["a" /* BlogComponent */], }
];
var MyOnsenModule = (function () {
    function MyOnsenModule() {
    }
    MyOnsenModule.routes = routes;
    MyOnsenModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                // Components / Directives/ Pipes
                __WEBPACK_IMPORTED_MODULE_4__my_onsen_component__["a" /* MyOnsenComponent */],
                __WEBPACK_IMPORTED_MODULE_5__page_type__["a" /* TypeComponent */],
                __WEBPACK_IMPORTED_MODULE_6__page_home__["a" /* HomeComponent */],
                __WEBPACK_IMPORTED_MODULE_7__page_blog__["a" /* BlogComponent */],
                __WEBPACK_IMPORTED_MODULE_8__page_login__["a" /* LoginComponent */]
            ],
            imports: [
    ...
    return MyOnsenModule;
}());
/* harmony default export */ exports["default"] = MyOnsenModule;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return OnsenSetting; });
var OnsenSetting = (function () {
    function OnsenSetting() {
    }
    Object.defineProperty(OnsenSetting, "base", {
        get: function () { return 'onsen/'; },
        enumerable: true,
        configurable: true
    });
    return OnsenSetting;
...
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return MyOnsenComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyOnsenComponent = (function () {
    function MyOnsenComponent() {
    }
    MyOnsenComponent.prototype.ngOnInit = function () {
        console.log('hello `Onsen` component');
    };
    MyOnsenComponent = __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__onsen_setting_component__ = __webpack_require__(914);
...
var BlogComponent = (function () {
    ...
    BlogComponent.prototype.back = function () {
        this.router.navigate([[__WEBPACK_IMPORTED_MODULE_2__onsen_setting_component__["a" /* OnsenSetting */].base + 'blog']]);
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__blog_component__ = __webpack_require__(1187);
/* harmony namespace reexport (by used) */ __webpack_require__.d(exports, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__blog_component__["a"]; });
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_component__ = __webpack_require__(1189);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__login_component__ = __webpack_require__(1192);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__onsen_setting_component__ = __webpack_require__(914);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__login_service__ = __webpack_require__(1193);
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.onClick = function () {
        var _this = this;
        this.loginService.userLogin().subscribe(function (term) {
            if (_this.username == term[0].username && _this.password == term[0].password) {
                ons.notification.alert('Congratulations!').then(function () {
                    _this.router.navigate([__WEBPACK_IMPORTED_MODULE_2__onsen_setting_component__["a" /* OnsenSetting */].base + 'blog']);
                });
            }
            else {
...
var LoginService = (function () {
    function LoginService(http) {
        ...
        this.header = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]({ 'Content-Type': 'application/json' });
    }
    LoginService.prototype.userLogin = function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__type_component__ = __webpack_require__(1195);
/* harmony namespace reexport (by used) */ __webpack_require__.d(exports, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__type_component__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(310);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__onsen_setting_component__ = __webpack_require__(914);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return TypeComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TypeComponent = (function () {
    ...
    TypeComponent.prototype.onClick = function () {
...
module.exports = "<ons-page>\r\n  <ons-toolbar>\r\n        <div class=\"center\">Log In</div>\r\n        <div class=\"right\"><ons-toolbar-button>Close</ons-toolbar-button></div>\r\n      </ons-toolbar>\r\n  <div class=\"login-form\">\r\n          <ons-input type=\"text\" class=\"text-input--underbar\" placeholder=\"Username\" float [(value)]=\"username\" required (input)=\"username = $event.target.value\"></ons-input>\r\n          <!--<div [hidden]=\"username.valid || username.pristine\" class=\"alert alert-danger\">\r\n            username is required\r\n          </div>-->\r\n          <br>\r\n          <br>\r\n          <ons-input type=\"password\" class=\"text-input--underbar\" placeholder=\"Password\" float [(value)]=\"password\" required (input)=\"password = $event.target.value\"></ons-input>\r\n          <!--<div [hidden]=\"password.valid || password.pristine\" class=\"alert alert-danger\">\r\n            password is required\r\n          </div>-->\r\n          <br><br>\r\n          <ons-button (click)=\"onClick(button)\" #button modifier=\"large\">Sign in</ons-button>\r\n          <ons-button modifier=\"quiet\" class=\"forgot-password\">Forgot password?</ons-button>\r\n  </div>\r\n</ons-page>\r\n"

/***/ },
/* 1225 */
/***/ function(module, exports) {

module.exports = "<ons-page>\r\n  <ons-toolbar>\r\n    <div class=\"left\">\r\n      <ons-back-button>Back</ons-back-button>\r\n    </div>\r\n    <div class=\"center\">Title</div>\r\n    <div class=\"right\">\r\n      <ons-toolbar-button>\r\n        <ons-icon icon=\"md-menu\"></ons-icon>\r\n      </ons-toolbar-button>\r\n    </div>\r\n  </ons-toolbar>\r\n  <div class=\"background\"></div>\r\n  <div class=\"content\">\r\n    <div class=\"text-center\">\r\n      <form>\r\n        <p></p>\r\n        <p>\r\n          <ons-input type=\"text\" placeholder=\"Username\" float></ons-input>\r\n        </p>\r\n        <p>\r\n          <ons-input type=\"password\" placeholder=\"Password\" float></ons-input>\r\n        </p>\r\n        <p>\r\n          <ons-button (click)=\"onClick(button)\" #button>Sign in</ons-button>\r\n        </p>\r\n      </form>\r\n    </div>\r\n    <ons-list>\r\n      <ons-list-header>Header</ons-list-header>\r\n      <ons-list-item>\r\n        <div class=\"left\">\r\n          <ons-icon icon=\"md-face\" class=\"list__item__icon\"></ons-icon>\r\n        </div>\r\n        <div class=\"center\">\r\n          <span class=\"list__item__title\">Title</span>\r\n          <span class=\"list__item__subtitle\">Subtitle</span>\r\n        </div>\r\n        <label class=\"right\">\r\n          <ons-switch></ons-switch>\r\n        </label>\r\n      </ons-list-item>\r\n    </ons-list>\r\n    \r\n    <li>\r\n      <a [routerLink]=\" [ '../type'] \">\r\n          type\r\n        </a>\r\n    </li>\r\n    <li>\r\n      <a [routerLink]=\" [ '../home'] \">\r\n          home\r\n        </a>\r\n    </li>\r\n    <li>\r\n      <a [routerLink]=\" [ '../blog'] \">\r\n          blog\r\n        </a>\r\n    </li>\r\n    <router-outlet></router-outlet>\r\n  </div>\r\n</ons-page>"
